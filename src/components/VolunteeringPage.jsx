import VolunteeringImg from './style/Volunteering.png'
...
import {AllVolunteer} from '../Api/PostsApis'
            ...
            <Container style={{ width: "95%" }}>
                <div>
                    <Row style={{ alignItems: "center" }}>
                        <Col lg={{ span: 1 }}>
                            <img className="Dlogo" src={VolunteeringImg} alt='Volunteering-logo' />
                        </Col>
                        <Col lg={{ span: 3 }} >
                            <p className="Plogo" >Volunteering</p>
                        </Col>
